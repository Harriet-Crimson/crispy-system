...
We are assuming that we will be able to connect to the hub, to send and retrieve data based on student information. It is also assumed that student information is stored in the hub.

The data might be separated into different databases, based on the specific functions of the system we chose to use. There may end up being different user interfaces, to reflect the different types of users interactions with the system.
